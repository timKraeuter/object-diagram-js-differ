...
import {Differ, diff} from '../lib/index.js';
...
describe('diffing', function() {
  ...
  describe('diff', function() {
    ...
    it('should discover add', function(done) {
      ...
      var aDiagram = readFileSync('spec/fixtures/add/before.bpmn', 'utf-8');
      var bDiagram = readFileSync('spec/fixtures/add/after.bpmn', 'utf-8');
    ...
    it('should discover remove', function(done) {
      ...
      var aDiagram = readFileSync('spec/fixtures/remove/before.bpmn', 'utf-8');
      var bDiagram = readFileSync('spec/fixtures/remove/after.bpmn', 'utf-8');
    ...
    it('should discover change', function(done) {
      ...
      var aDiagram = readFileSync('spec/fixtures/change/before.bpmn', 'utf-8');
      var bDiagram = readFileSync('spec/fixtures/change/after.bpmn', 'utf-8');
    ...
    it('should discover layout-change', function(done) {
      ...
      var aDiagram = readFileSync('spec/fixtures/layout-change/before.bpmn', 'utf-8');
      var bDiagram = readFileSync('spec/fixtures/layout-change/after.bpmn', 'utf-8');
  ...
  describe('should diff scenario', function() {
    ...
    it('collaboration pools / lanes', function(done) {
      ...
      var aDiagram = readFileSync('spec/fixtures/collaboration/before.bpmn', 'utf-8');
      var bDiagram = readFileSync('spec/fixtures/collaboration/after.bpmn', 'utf-8');
    ...
    it('lanes create', function(done) {
      ...
      var aDiagram = readFileSync('spec/fixtures/lanes/create-laneset-before.bpmn', 'utf-8');
      var bDiagram = readFileSync('spec/fixtures/lanes/create-laneset-after.bpmn', 'utf-8');
    ...
    it('lanes remove', function(done) {
      ...
      var aDiagram = readFileSync('spec/fixtures/lanes/create-laneset-after.bpmn', 'utf-8');
      var bDiagram = readFileSync('spec/fixtures/lanes/create-laneset-before.bpmn', 'utf-8');
    ...
    it('collaboration message flow', function(done) {
      ...
      var aDiagram = readFileSync('spec/fixtures/collaboration/message-flow-before.bpmn', 'utf-8');
      var bDiagram = readFileSync('spec/fixtures/collaboration/message-flow-after.bpmn', 'utf-8');
    ...
    it('extension elements', function(done) {
      ...
      var aDiagram = readFileSync('spec/fixtures/extension-elements/before.bpmn', 'utf-8');
      var bDiagram = readFileSync('spec/fixtures/extension-elements/after.bpmn', 'utf-8');
    ...
    it('pizza collaboration StartEvent move', function(done) {
      ...
      var aDiagram = readFileSync('spec/fixtures/pizza-collaboration/start-event-old.bpmn', 'utf-8');
      var bDiagram = readFileSync('spec/fixtures/pizza-collaboration/start-event-new.bpmn', 'utf-8');
    ...
    it('pizza collaboration', function(done) {
      ...
      var aDiagram = readFileSync('spec/fixtures/pizza-collaboration/old.bpmn', 'utf-8');
      var bDiagram = readFileSync('spec/fixtures/pizza-collaboration/new.bpmn', 'utf-8');
    ...
    it('data-objects', function(done) {
      ...
      var aDiagram = readFileSync('spec/fixtures/data-objects/before.bpmn', 'utf-8');
      var bDiagram = readFileSync('spec/fixtures/data-objects/after.bpmn', 'utf-8');
    ...
    it('event definition', function(done) {
      ...
      var aDiagram = readFileSync('spec/fixtures/event-definition/before.bpmn', 'utf-8');
      var bDiagram = readFileSync('spec/fixtures/event-definition/after.bpmn', 'utf-8');
    ...
    it('sub-processes', function(done) {
      ...
      var aDiagram = readFileSync('spec/fixtures/sub-processes/before.bpmn', 'utf-8');
      var bDiagram = readFileSync('spec/fixtures/sub-processes/after.bpmn', 'utf-8');
    ...
    it('signavio-collapsed', function(done) {
      ...
      var aDiagram = readFileSync('spec/fixtures/signavio-collapsed/before.collapsed.bpmn', 'utf-8');
      var bDiagram = readFileSync('spec/fixtures/signavio-collapsed/after.expanded.bpmn', 'utf-8');
    ...
    it('different collaborations', function(done) {
      ...
      const aDiagram = readFileSync('spec/fixtures/different-collaboration/before.bpmn', 'utf-8');
      const bDiagram = readFileSync('spec/fixtures/different-collaboration/after.bpmn', 'utf-8');
...
function importDiagrams(a, b, done) {
  new BpmnModdle().fromXML(a).then(adefs => {
    new BpmnModdle().fromXML(b).then(bdefs => {
      return done(null, adefs.rootElement, bdefs.rootElement);
    })
  })
}
